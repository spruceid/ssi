    ...
    for (key, mut value) in level_three_object_2 {
        ...
        if key == 138 {
            ...
            if value == vec![65] {
                ...
                suffix = value;
            } else if value == vec![16] || value == vec![17] ||value == vec![18] ||value == vec![19] ||value == vec![20] ||value == vec![21] {
                suffix = value;
            }
        } else {
            suffix = value;
...
mod tests {
    ...
    async fn test_age_over() {
        let bytes: Vec<u8> = vec![
            217,   5,   1, 163,   0,  17,  24, 116,  24, 110,  24, 124,
            168,   1, 131,  17,  22,  20,  24, 112, 130,   3,  80, 159,
             95, 241, 151, 214, 212,  74,  61, 166, 130,  52, 252, 121,
            150, 103,  67,  24, 114, 165,  24, 116,  24, 150,  24, 182,
             26,  99, 123, 190, 237,  24, 190,  24, 196,  24, 192,  88,
             65, 122,  29, 132, 172,  43, 117, 194, 204, 250, 248, 229,
            124, 199, 188, 148, 223, 155, 115,  20,  41,  26,  67, 235,
             13,  87, 234, 212, 223, 223,  47,   5, 117, 167,  96,  70,
            197,  16, 232, 137,  25, 106, 254, 243, 233,  73, 105,  34,
             98, 253, 232, 219, 252,  91,  82,  95, 114, 249,  18, 108,
             78,  15, 236,  27,  70,   4,  24, 194, 131,  25,   4,   1,
             88,  34, 237,   1, 145, 251, 113, 106,  74, 102,  30, 197,
            251, 100,  54, 179, 246,  34,  94, 191, 193,  10, 126, 218,
             96, 210, 180, 187,  94, 111, 179, 236, 251, 177,  32, 127,
             88,  34, 237,   1, 145, 251, 113, 106,  74, 102,  30, 197,
            251, 100,  54, 179, 246,  34,  94, 191, 193,  10, 126, 218,
             96, 210, 180, 187,  94, 111, 179, 236, 251, 177,  32, 127,
             24, 117, 130,  24, 108,  24, 130,  24, 158, 162,  24, 138,
             88,  88, 122, 217,   5,   1, 164,   0,  21,  24, 106,  24,
            100,  24, 108,  75, 122, 217,   5,   1, 162,   0,  22,  24,
            124,  24,  65,  24, 110,  88,  59, 122,   0,   0, 154,  62,
             19,  12,  98, 215,   0, 228,  10, 131, 136, 163, 163, 172,
             79, 141, 241, 174, 208, 229, 150, 211,  46, 189, 197,  40,
            226,  35,  68,  62, 154,  28, 203,  36, 251, 193, 148, 128,
            236, 156, 224,  57,  55, 228,  84, 139,  92, 193,  42, 156,
             45,   6,  52, 237,  63, 192,  24, 148,   0,  24, 162,  26,
             99, 245,   8, 236,  24, 164,  26,  99, 123, 190, 236,  24,
            168, 130,  25,   4,   1,  88,  34, 237,   1, 145, 251, 113,
            106,  74, 102,  30, 197, 251, 100,  54, 179, 246,  34,  94,
            191, 193,  10, 126, 218,  96, 210, 180, 187,  94, 111, 179,
            236, 251, 177,  32, 127
        ];
