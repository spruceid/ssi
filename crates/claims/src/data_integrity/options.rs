...
pub struct AnySuiteOptions {
    ...
    pub eip712: Option<ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::Eip712Options>,
...
impl From<Option<ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::Eip712Options>>
    for AnySuiteOptions
{
    fn from(
        value: Option<ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::Eip712Options>,
    ) -> Self {
        Self {
            eip712: value.clone(),
            ..Default::default()
    ...
    fn as_reference(&self) -> Self::Reference<'_> {
        AnySuiteOptionsRef {
            ...
            eip712: self
                .eip712
                .as_ref()
                .map(ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::Eip712Options::as_ref),
            eip712_v0_1: self.eip712_v0_1.as_ref().map(
                ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::v0_1::Eip712Options::as_ref,
            ),
        }
    }
...
#[cfg(feature = "tezos")]
impl<'a> TryFrom<AnySuiteOptionsRef<'a>> for ssi_vc_data_integrity::suite::tezos::OptionsRef<'a> {
...
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity::suite::tezos::tezos_signature_2021::OptionsRef<'a>
{
...
#[cfg(feature = "tezos")]
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity::suite::tezos::tezos_jcs_signature_2021::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
...
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
            eip712: value.eip712,
...
#[cfg(all(feature = "w3c", feature = "eip712"))]
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity::suite::ethereum_eip712_signature_2021::v0_1::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
