...
impl From<ssi_crypto::Error> for SignatureError {
    fn from(value: ssi_crypto::Error) -> Self {
        match value {
            ssi_crypto::Error::AlgorithmUnsupported(a) => Self::UnsupportedAlgorithm(a.to_string()),
            e => Self::other(e),
        }
    }
}
