...
use linked_data::{rdf_types::{Interpretation, Vocabulary}, GraphVisitor, LinkedData, LinkedDataGraph, LinkedDataResource, LinkedDataSubject, SubjectVisitor, Visitor};

impl<I: Interpretation, V: Vocabulary, C: Provable + LinkedDataResource<I, V>> LinkedDataResource<I, V> for Verifiable<C> {
    fn interpretation(
        &self,
        vocabulary: &mut V,
...
pub trait LinkedDataSubjectClaims<I: Interpretation, V: Vocabulary>: Provable {
    fn visit_subject_with_proof<S>(&self, proof: &Self::Proof, visitor: S) -> Result<S::Ok, S::Error>
    where
        S: SubjectVisitor<I, V>;
}

impl<I: Interpretation, V: Vocabulary, C: LinkedDataSubjectClaims<I, V>> LinkedDataSubject<I, V> for Verifiable<C> {
...
impl<I: Interpretation, V: Vocabulary, C: LinkedDataGraphClaims<I, V>> LinkedDataGraph<I, V> for Verifiable<C> {
