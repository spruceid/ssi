...
use ssi_vc_data_integrity_core::suite::{CryptographicSuiteOptions, InvalidOptions};
...
pub struct AnySuiteOptions {
    ...
    pub eip712: Option<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options>,

    #[ld("eip712v0.1:eip712-domain")]
    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "eip712Domain")]
    pub eip712_v0_1:
        Option<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::v0_1::Eip712Options>,
}
...
impl AnySuiteOptions {
    ...
    pub fn with_public_key(self, jwk: JWK) -> Result<Self, ssi_jws::Error> {
        let public_key_multibase =
            Some(ssi_vc_data_integrity_suites::tezos::encode_jwk_to_multibase(&jwk)?);
        Ok(Self {
...
impl From<Option<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options>>
    for AnySuiteOptions
{
    fn from(
        value: Option<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options>,
    ) -> Self {
        Self {
            eip712: value.clone(),
            ..Default::default()
...
impl From<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options>
    for AnySuiteOptions
{
    fn from(
        value: ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options,
    ) -> Self {
        Self {
    ...
    fn as_reference(&self) -> Self::Reference<'_> {
        AnySuiteOptionsRef {
            ...
            eip712: self
                .eip712
                .as_ref()
                .map(ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712Options::as_ref),
            eip712_v0_1: self.eip712_v0_1.as_ref().map(
                ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::v0_1::Eip712Options::as_ref,
            ),
        }
    }
...
pub struct AnySuiteOptionsRef<'a> {
    ...
    #[serde(rename = "eip712Domain")]
    pub eip712:
        Option<ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::Eip712OptionsRef<'a>>,

    #[serde(skip_serializing_if = "Option::is_none")]
    #[serde(rename = "eip712Domain")]
    pub eip712_v0_1: Option<
        ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::v0_1::Eip712OptionsRef<'a>,
    >,
}
...
#[cfg(feature = "tezos")]
impl<'a> TryFrom<AnySuiteOptionsRef<'a>> for ssi_vc_data_integrity_suites::tezos::OptionsRef<'a> {
...
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity_suites::tezos::tezos_signature_2021::OptionsRef<'a>
{
...
#[cfg(feature = "tezos")]
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity_suites::tezos::tezos_jcs_signature_2021::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
...
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
            eip712: value.eip712,
...
#[cfg(all(feature = "w3c", feature = "eip712"))]
impl<'a> From<AnySuiteOptionsRef<'a>>
    for ssi_vc_data_integrity_suites::ethereum_eip712_signature_2021::v0_1::OptionsRef<'a>
{
    fn from(value: AnySuiteOptionsRef<'a>) -> Self {
        Self {
