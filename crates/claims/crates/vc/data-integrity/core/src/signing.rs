...
use rdf_types::{
    ExportedFromVocabulary, InterpretationMut, Literal, ReverseBlankIdInterpretation,
    ReverseIriInterpretation, ReverseLiteralInterpretation, VocabularyMut,
};
...
) -> Result<Verifiable<Claims<T, Proof<S>>>, Error<X::LoadError>>
where
    T: WithJsonLdContext,
