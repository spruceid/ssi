...
use ssi_jwk::JWK;
use ssi_jws::{url_safe_jws, UrlSafeJws};
...
async fn rfc_a_1_example_2_verification() {
    ...
    const JWT: &UrlSafeJws = url_safe_jws!("eyJhbGciOiAiRVMyNTYiLCAidHlwIjogImV4YW1wbGUrc2Qtand0In0..H0uI6M5t7BDfAt_a3Rw5zq4IiYNtkMORENcQFXYkW1LURRp66baOXRcxb164snsUJneI-XLM2-COCTX1y7Sedw");
...
async fn rfc_a_2_example_3_verification() {
    ...
    const JWT: &UrlSafeJws = url_safe_jws!("eyJhbGciOiAiRVMyNTYiLCAidHlwIjogImV4YW1wbGUrc2Qtand0In0..BYUpdUIaUTNj5UlPBk6g0GhDp213yGD_HIMk8P45LwkSAfZgc_ayGnf9VC4gebeE-crDoonxf89Y7qsTA-4qdQ");
