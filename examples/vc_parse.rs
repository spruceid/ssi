...
use ssi_claims::{data_integrity::AnyDataIntegrity, vc::v1::JsonCredential};
...
async fn main() {
    ...
    let vc: AnyDataIntegrity<JsonCredential> = serde_json::from_str(&credential_content).unwrap();
